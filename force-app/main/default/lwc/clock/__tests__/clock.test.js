...
describe('c-clock', () => {
    ...
    it('renders one lightning-formatted-date-time elmement', () => {
        ...
        const lightningDateTimeEls = element.shadowRoot.querySelectorAll(
            'lightning-formatted-date-time',
        );
        expect(lightningDateTimeEls.length).toBe(1);
    });
