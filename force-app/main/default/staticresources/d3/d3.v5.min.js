...
!(function(t, n) {
    'object' == typeof exports && 'undefined' != typeof module
        ? n(exports)
        : 'function' == typeof define && define.amd ? define(['exports'], n) : n((t.d3 = t.d3 || {}));
})(this, function(t) {
    'use strict';
    function n(t, n) {
    ...
    function f(t, n) {
        var e,
            ...
            f = 0,
            c = 0;
        if (null == n) for (; ++a < i; ) isNaN((e = u(t[a]))) || (c += (r = e - f) * (e - (f += r / ++o)));
        else for (; ++a < i; ) isNaN((e = u(n(t[a], a, t)))) || (c += (r = e - f) * (e - (f += r / ++o)));
        if (o > 1) return c / (o - 1);
    }
    function c(t, n) {
        var e = f(t, n);
        ...
        function l(l) {
            ...
            (m = m.merge(
                ...
                m.attr(
                    'd',
                    t === D || t == R
                        ? a ? 'M' + f * a + ',' + g + 'H0.5V' + y + 'H' + f * a : 'M0.5,' + g + 'V' + y
                        : a ? 'M' + g + ',' + f * a + 'V0.5H' + y + 'V' + f * a : 'M' + g + ',0.5H' + y,
                ),
    ...
    function ft(t, n, e, r, i, o, a) {
        var u,
            ...
            d = new Array(l);
        for (u = 0; u < l; ++u)
            (f = n[u]) && ((d[u] = c = at + a.call(f, f.__data__, u, n)), c in s ? (i[u] = f) : (s[c] = f));
        for (u = 0; u < h; ++u)
    ...
    ((t.event = null), 'undefined' != typeof document) &&
        ('onmouseenter' in document.documentElement || (Tt = { mouseenter: 'mouseover', mouseleave: 'mouseout' }));
    function Nt(t, n, e) {
        return (
            (t = St(t, n, e)),
            function(n) {
                        ...
                        : (n = ln.exec(t))
                          ...
                          : (n = hn.exec(t))
                            ...
                            : (n = dn.exec(t))
                              ...
                              : pn.hasOwnProperty(t) ? gn(pn[t]) : 'transparent' === t ? new mn(NaN, NaN, NaN, 0) : null
        );
    }
    function gn(t) {
    ...
    Kt(
        ...
        tn(nn, {
            ...
            rgb: function() {
                ...
                return new mn(
                    Bn(3.1338561 * (n = En * Yn(n)) - 1.6168667 * (t = kn * Yn(t)) - 0.4906146 * (e = Cn * Yn(e))),
    ...
    Kt(
        ...
        tn(nn, {
            brighter: function(t) {
                return (
                    (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new te(this.h, this.s, this.l * t, this.opacity)
                );
            },
            darker: function(t) {
                return (t = null == t ? 0.7 : Math.pow(0.7, t)), new te(this.h, this.s, this.l * t, this.opacity);
            },
            rgb: function() {
                  ...
                  : 'string' === r
                    ...
                    : n instanceof vn
                      ...
                      : n instanceof Date
                        ...
                        : Array.isArray(n)
                          ? de
                          : ('function' != typeof n.valueOf && 'function' != typeof n.toString) || isNaN(n) ? ge : ve)(
                  t,
                  n,
              );
    }
    ...
    var Ce = ke(
            function(t) {
                return 'none' === t
                    ...
                    : (we ||
                      ...
                      (t = Ae.getComputedStyle(Me.appendChild(we), null).getPropertyValue('transform')),
                      Me.removeChild(we),
                      Ee(+(t = t.slice(7, -1).split(','))[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
            },
            'px, ',
            'px)',
            'deg)',
        ...
        Pe = ke(
            function(t) {
                return null == t
                    ? Se
                    : (Te || (Te = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
                      Te.setAttribute('transform', t),
                      (t = Te.transform.baseVal.consolidate()) ? Ee((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Se);
            },
            ', ',
            ')',
            ')',
                ...
                (function() {
                    ...
                    for (; e; )
                        e._call
                            ...
                            : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Ve = n)));
                    ($e = t), lr(r);
                })(),
                (tr = 0);
        }
    ...
    function lr(t) {
        We ||
            ...
            t - tr > 24
                ? (t < 1 / 0 && (Ze = setTimeout(cr, t - er.now() - nr)), Qe && (Qe = clearInterval(Qe)))
                : (Qe || ((Ke = er.now()), (Qe = setInterval(sr, Je))), (We = 1), rr(cr)));
    }
    function hr(t, n, e) {
        var r = new ar();
        return (
    ...
    ar.prototype = ur.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            (e = (null == e ? ir() : +e) + (null == n ? 0 : +n)),
                this._next || $e === this || ($e ? ($e._next = this) : (Ve = this), ($e = this)),
                (this._call = t),
                (this._time = e),
                lr();
        },
        ...
        !(function(t, n, e) {
            ...
            function o(f) {
                ...
                if (
                    ...
                    for (e.state = _r, r = new Array((l = e.tween.length)), c = 0, s = -1; c < l; ++c)
                        (h = e.tween[c].value.call(t, t.__data__, e.index, e.group)) && (r[++s] = h);
                    r.length = s + 1;
                }
            }
            function a(n) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
                for (var u, f, c = r[a], s = c.length, l = (o[a] = new Array(s)), h = 0; h < s; ++h)
                    (u = c[h]) &&
                        ...
                        ('__data__' in u && (f.__data__ = u.__data__), (l[h] = f), wr(l[h], n, e, h, l, Tr(u, e)));
        ...
        selectAll: function(t) {
            ...
            for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
                for (var f, c = r[u], s = c.length, l = 0; l < s; ++l)
                    if ((f = c[l])) {
                        for (var h, d = t.call(f, f.__data__, l, c), p = Tr(f, e), v = 0, g = d.length; v < g; ++v)
                          ...
                          ? (function(t, n, e) {
                                ...
                                return function() {
                                    var a = lt(this, t),
                                        u = e(this);
                                    return (
                                        null == u && (this.style.removeProperty(t), (u = lt(this, t))),
    ...
    function ni(t) {
        return (t = +t) < Xr
            ? ti * t * t
            : t < Vr ? ti * (t -= Gr) * t + $r : t < Zr ? ti * (t -= Wr) * t + Qr : ti * (t -= Jr) * t + Kr;
    }
    var ei = (function t(n) {
            function e(t) {
                return t * t * ((n + 1) * t - n);
    ...
    function Ri(n) {
        ...
        function l() {
            ...
            function Y() {
                ...
                switch (((p = R[0] - z[0]), (v = R[1] - z[1]), x)) {
                    case yi:
                    case gi:
                        w && ((p = Math.max(S - r, Math.min(k - s, p))), (o = r + p), (l = s + p)),
                            M && ((v = Math.max(E - a, Math.min(C - h, v))), (u = a + v), (d = h + v));
                        break;
                    case _i:
                        w < 0
                            ? ((p = Math.max(S - r, Math.min(k - r, p))), (o = r + p), (l = s))
                            : w > 0 && ((p = Math.max(S - s, Math.min(k - s, p))), (o = r), (l = s + p)),
                            M < 0
                                ? ((v = Math.max(E - a, Math.min(C - a, v))), (u = a + v), (d = h))
                                : M > 0 && ((v = Math.max(E - h, Math.min(C - h, v))), (u = a), (d = h + v));
                        break;
                    case bi:
                        w && ((o = Math.max(S, Math.min(k, r - p * w))), (l = Math.max(S, Math.min(k, s + p * w)))),
                            M && ((u = Math.max(E, Math.min(C, a - v * M))), (d = Math.max(E, Math.min(C, h + v * M))));
                }
                l < o &&
                    ((w *= -1),
                    (t = r),
                    ...
                    (N[0][0] === o && N[0][1] === u && N[1][0] === l && N[1][1] === d) ||
                        ((A.selection = [[o, u], [l, d]]), f.call(b), L.brush());
            }
            function B() {
        ...
        return (
            ...
            (u.extent = function(t) {
                return arguments.length
                    ? ((r = 'function' == typeof t ? t : hi([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])), u)
                    : r;
            }),
            (u.filter = function(t) {
        ...
        function o(e, i) {
            ...
            return (
                (function(e, r, i) {
                    ...
                    for (; ++u < n - 1; ) {
                        for (
                            o = -1, c = e[u * t + t] >= r, s = e[u * t] >= r, vo[(c << 1) | (s << 2)].forEach(p);
                            ++o < t - 1;
        ...
        function u(e, r, i) {
            e.forEach(function(e) {
                var o,
                    ...
                    c = 0 | u,
                    s = r[c * t + f];
                a > 0 && a < t && f === a && ((o = r[c * t + f - 1]), (e[0] = a + (i - o) / (s - o) - 0.5)),
                    u > 0 && u < n && c === u && ((o = r[(c - 1) * t + f]), (e[1] = u + (i - o) / (s - o) - 0.5));
            });
        }
        return (
            (i.contour = o),
            ...
            (i.thresholds = function(t) {
                return arguments.length
                    ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? co(uo.call(t)) : co(t)), i)
                    : e;
            }),
            (i.smooth = function(t) {
    ...
    (aa.copy = function() {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
            for (var i = 0; i < 4; ++i)
                (n = r.source[i]) &&
                    (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = oa(n)));
        return e;
    }),
        (aa.add = function(t) {
        ...
        (aa.addAll = function(t) {
            ...
            for (e = 0; e < o; ++e)
                isNaN((r = +this._x.call(null, (n = t[e])))) ||
                    ...
                    ((a[e] = r), (u[e] = i), r < f && (f = r), r > s && (s = r), i < c && (c = i), i > l && (l = i));
            for (
    ...
    function xa(t, n) {
        ...
        return i < 0
            ...
            : r.length > i + 1 ? r.slice(0, i + 1) + '.' + r.slice(i + 1) : r + new Array(i - r.length + 2).join('0');
    }
    ...
    function Na(t) {
        ...
        function f(t) {
            var n = (t = ba(t)).fill,
                ...
                p = t.trim,
                v = t.type;
            'n' === v ? ((h = !0), (v = 'g')) : wa[v] || (null == d && (d = 12), (p = !0), (v = 'g')),
                (s || ('0' === n && '=' === e)) && ((s = !0), (n = '0'), (e = '='));
        ...
        rf = {
            ...
            polygonEnd: function() {
                _u.polygonEnd(),
                    ...
                    (rf.lineStart = uf),
                    (rf.lineEnd = ff),
                    gu < 0 ? ((Cu = -(zu = 180)), (Pu = -(Ru = 90))) : ef > Da ? (Ru = 90) : ef < -Da && (Pu = -90),
                    (Yu[0] = Cu),
                    (Yu[1] = zu);
            },
        };
        ...
        if (qu) {
            ...
            c ^ (u * Lu < f && f < u * t)
                ...
                : c ^ (u * Lu < (f = (f + 360) % 360 - 180) && f < u * t)
                  ...
                  : (n < Pu && (Pu = n), n > Ru && (Ru = n)),
                c
                    ? t < Lu ? hf(Cu, t) > hf(Cu, zu) && (zu = t) : hf(t, zu) > hf(Cu, zu) && (Cu = t)
                    : zu >= Cu
                      ? (t < Cu && (Cu = t), t > zu && (zu = t))
                      : t > Lu ? hf(Cu, t) > hf(Cu, zu) && (zu = t) : hf(t, zu) > hf(Cu, zu) && (Cu = t);
    ...
    function mf(t, n) {
        ...
        var e = Ga((n *= Ia)),
            ...
            o = Qa(n),
            a = Xa(
                Ka((a = tf * o - nf * i) * a + (a = nf * r - Ku * o) * a + (a = Ku * i - tf * r) * a),
                Ku * r + tf * i + nf * o,
            );
        (Fu += a),
            (Xu += a * (Ku + (Ku = r))),
    ...
    function Lf(t, n, e, r, i, o) {
        if (e) {
            ...
            null == i
                ? ((i = n + r * Ba), (o = n - f / 2))
                : ((i = Df(a, i)), (o = Df(a, o)), (r > 0 ? i < o : i > o) && (i += r * Ba));
    ...
    function Yf(t, n, e, r, i) {
        ...
        if (
            ...
            for (var c, s, l = u[0]; ; ) {
                ...
                do {
                    if (((h.v = h.o.v = !0), h.e)) {
                        if (d) for (o = 0, a = c.length; o < a; ++o) i.point((s = c[o])[0], s[1]);
                        else r(h.x, h.n.x, 1, i);
                        h = h.n;
                    } else {
                        if (d) for (c = h.p.z, o = c.length - 1; o >= 0; --o) i.point((s = c[o])[0], s[1]);
    ...
    function If(t, n) {
        ...
        for (var f = 0, c = t.length; f < c; ++f)
            if ((l = (s = t[f]).length))
                for (
                    var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + Ya, v = Qa(p), g = Ga(p), y = 0;
                    y < l;
                    ++y, d = b, v = x, g = w, h = _
                ) {
                    var _ = s[y],
                        ...
                        : i !== u &&
                          ...
                          (r = (function(t, n, e, r) {
                              var i,
                                  ...
                                  a = Qa(t - e);
                              return Ha(a) > Da
                                  ? ja((Qa(n) * (o = Ga(r)) * Qa(e) - Qa(r) * (i = Ga(n)) * Qa(t)) / (i * o * a))
                                  : (n + r) / 2;
                          })(e, r, o, a)),
                          t.point(i, r),
                          t.lineEnd(),
        ...
        function a(t, e, r) {
            ...
            if (!(g < 0)) {
                ...
                if (
                    (!T && M < w && ((b = w), (w = M), (M = b)),
                    T || A < Da
                        ? T ? (w + M > 0) ^ (_[1] < (Ha(_[0] - m) < Da ? w : M)) : w <= _[1] && _[1] <= M
                        : (A > qa) ^ (m <= _[0] && _[0] <= x))
                ) {
                    var N = Eu(d, (-p + y) / v);
    ...
    function Zf(t, n, e, r) {
        ...
        function a(r, i) {
            return Ha(r[0] - t) < Da
                ? i > 0 ? 0 : 3
                : Ha(r[0] - e) < Da ? (i > 0 ? 2 : 1) : Ha(r[1] - n) < Da ? (i > 0 ? 1 : 0) : i > 0 ? 3 : 2;
        }
        function u(t, n) {
            return f(t.x, n.x);
        }
        function f(t, n) {
            ...
            return e !== r
                ? e - r
                : 0 === e ? n[1] - t[1] : 1 === e ? t[0] - n[0] : 2 === e ? t[1] - n[1] : n[0] - t[0];
        }
        return function(a) {
            var f,
                c,
                    ...
                    polygonEnd: function() {
                        var n = (function() {
                                for (var n = 0, e = 0, i = c.length; e < i; ++e)
                                    for (
                                        var o, a, u = c[e], f = 1, s = u.length, l = u[0], h = l[0], d = l[1];
                                        f < s;
                                        ++f
                                    )
                                        (o = h),
            ...
            function M(o, a) {
                ...
                if ((c && s.push([o, a]), y)) (l = o), (h = a), (d = u), (y = !1), u && (b.lineStart(), b.point(o, a));
                    ...
                    !(function(t, n, e, r, i, o) {
                        ...
                        : (g || (b.lineStart(), b.point(f[0], f[1])), b.point(m[0], m[1]), u || b.lineEnd(), (_ = !1));
                }
                (p = o), (v = a), (g = u);
            }
            return x;
    ...
    function bc() {
        ...
        return (
            ...
            (_.precision = function(h) {
                return arguments.length
                    ? ((y = +h), (f = yc(o, i, 90)), (c = _c(n, t, y)), (s = yc(u, a, 90)), (l = _c(r, e, y)), _)
                    : y;
            }),
                  ...
                  function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
                      ...
                      if (b > 4 * n && v--) {
                          var m = a + h,
                              ...
                              C = E - i,
                              P = _ * k - y * C;
                          (P * P / b > n || Ha((y * k + _ * C) / b - 0.5) > 0.3 || a * h + u * d + f * p < Ns) &&
            ...
            (T.clipExtent = function(t) {
                return arguments.length
                    ? ((M =
                          null == t
                              ? ((w = r = i = o = null), mc)
                              : Zf((w = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
                      E())
                    : null == w ? null : [[w, r], [i, o]];
            }),
            (T.scale = function(t) {
        ...
        function s() {
            ...
            return f(
                null == c
                    ...
                    : t === Bs
                      ? [[Math.max(u[0] - o, c), n], [Math.min(u[0] + o, e), r]]
                      : [[c, Math.max(u[1] - o, n)], [e, Math.min(u[1] + o, r)]],
            );
        }
        return (
            (i.scale = function(t) {
            ...
            (i.clipExtent = function(t) {
                return arguments.length
                    ? (null == t
                          ? (c = n = e = r = null)
                          : ((c = +t[0][0]), (n = +t[0][1]), (e = +t[1][0]), (r = +t[1][1])),
                      s())
                    : null == c ? null : [[c, n], [e, r]];
            }),
            s()
        ...
        for (null == n && (n = cl); (e = c.pop()); )
            if ((f && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length)))
                for (e.children = new Array(a), o = a - 1; o >= 0; --o)
                    c.push((r = e.children[o] = new hl(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
    ...
    (Qs.invert = function(t, n) {
        for (
            ...
            ((o =
                (i =
                    (r -= e =
                        (r * (Gs + Vs * i + o * ($s + Ws * i)) - n) / (Gs + 3 * Vs * i + o * (7 * $s + 9 * Ws * i))) *
                    r) *
                i *
                i),
            !(Ha(e) < Ua));
    ...
    function vl(t, n) {
        ...
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r)
                if (gl(ml(t[e], t[r]), n) && gl(ml(t[e], n), t[r]) && gl(ml(t[r], n), t[e]) && _l(xl(t[e], t[r], n), t))
                    return [t[e], t[r], n];
        throw new Error();
    }
    function gl(t, n) {
    ...
    function Wl(t, n, e, r, i, o) {
        for (
            var a, u, f, c, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value;
            b < x;
            ...
            for (
                l = h = s, g = s * s * (v = Math.max(c / f, f / c) / (w * t)), p = Math.max(h / g, g / l);
                m < x;
                ++m
            ) {
                if (
            ...
            y.push((a = { value: s, dice: f < c, children: _.slice(b, m) })),
                a.dice ? Dl(a, e, r, i, w ? (r += c * s / w) : o) : Vl(a, e, r, w ? (e += f * s / w) : i, o),
                (w -= s),
                (b = m);
        }
        return y;
    ...
    function _h(t, n, e, r) {
        var o = Math.min(t.length, n.length) - 1,
            ...
            u = new Array(o),
            f = -1;
        for (t[o] < t[0] && ((t = t.slice().reverse()), (n = n.slice().reverse())); ++f < o; )
        ...
        return (
                ...
                return (function(n, e, r) {
                    ...
                    switch ((r = ba(null == r ? ',f' : r)).type) {
                        case 's':
                            ...
                            return (
                                null != r.precision || isNaN((i = ka(u, f))) || (r.precision = i), t.formatPrefix(r, f)
                            );
                        case '':
                        case 'e':
                        case 'g':
            ...
            (n.nice = function(t) {
                ...
                return (
                    ...
                    (r = x(u, f, t)) > 0
                        ? (r = x((u = Math.floor(u / r) * r), (f = Math.ceil(f / r) * r), t))
                        : r < 0 && (r = x((u = Math.ceil(u * r) / r), (f = Math.floor(f * r) / r), t)),
                    r > 0
                        ? ((i[o] = Math.floor(u / r) * r), (i[a] = Math.ceil(f / r) * r), e(i))
                        : r < 0 && ((i[o] = Math.ceil(u * r) / r), (i[a] = Math.floor(f * r) / r), e(i)),
                    n
                );
            }),
            n
        ...
        function w(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < c; )
                    37 === t.charCodeAt(u) &&
                        (a.push(t.slice(f, u)),
                        null != (i = Fd[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = 'e' === r ? ' ' : '0'),
                        (o = n[r]) && (r = o(e, i)),
                        a.push(r),
                        (f = u + 1));
    ...
    function cv(t, n, r, i, o, a, u, f, c) {
        ...
        function M(e) {
            return (u(e) < e
                ? d
                : a(e) < e ? p : o(e) < e ? v : i(e) < e ? g : n(e) < e ? (r(e) < e ? y : _) : t(e) < e ? b : m)(e);
        }
        function A(n, r, i, o) {
    ...
    function ey() {
        ...
        function a(a) {
            ...
            for (null == r && (o = i((c = Gi()))), u = 0; u <= s; ++u)
                !(u < s && e((f = a[u]), u, a)) === l && ((l = !l) ? o.lineStart() : o.lineEnd()),
    ...
    function a_(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (o_(o) + o_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function u_(t, n) {
        var e = t._x1 - t._x0;
            ...
            if (((o = r - f), h || !(o < 0))) {
                ...
                if (((o = e - c), d || !(o > 0))) {
                    ...
                    if (((o = i - c), d || !(o < 0))) {
                        ...
                        return (
                            !(s > 0 || l < 1) ||
                            (s > 0 && (t[0] = [f + s * h, c + s * d]), l < 1 && (t[1] = [f + l * h, c + l * d]), !0)
                        );
                    }
                }
            }
        ...
        (M_.prototype = {
            ...
            insert: function(t, n) {
                ...
                if (t) {
                    ...
                    this._
                        ? ((t = S_(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
                        : ((n.P = n.N = null), (this._ = n), (e = null));
                for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
                    e === (r = e.U).L
                        ? (i = r.R) && i.C
                          ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                          : (t === e.R && (T_(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), N_(this, r))
                        : (i = r.L) && i.C
                          ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                          : (t === e.L && (N_(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), T_(this, r)),
                        (e = t.U);
                this._.C = !1;
            },
            remove: function(t) {
                ...
                if (
                    ...
                    if (t && t.C) t.C = !1;
                        ...
                        do {
                            ...
                            if (t === i.L) {
                                if (
                                    ((n = i.R).C && ((n.C = !1), (i.C = !0), T_(this, i), (n = i.R)),
                                    (n.L && n.L.C) || (n.R && n.R.C))
                                ) {
                                    (n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), N_(this, n), (n = i.R)),
                                        (n.C = i.C),
                                        (i.C = n.R.C = !1),
                                        T_(this, i),
                                        (t = this._);
                                ...
                                ((n = i.L).C && ((n.C = !1), (i.C = !0), N_(this, i), (n = i.L)),
                                (n.L && n.L.C) || (n.R && n.R.C))
                            ) {
                                (n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), T_(this, n), (n = i.L)),
                                    (n.C = i.C),
                                    (i.C = n.L.C = !1),
                                    N_(this, i),
                                    (t = this._);
    ...
    function X_(t) {
        var n = t.circle,
            ...
            u = [t];
        j_(t);
        for (var f = o; f.circle && Math.abs(e - f.circle.x) < K_ && Math.abs(r - f.circle.cy) < K_; )
            (o = f.P), u.unshift(f), j_(f), (f = o);
        u.unshift(f), B_(f);
        for (var c = a; c.circle && Math.abs(e - c.circle.x) < K_ && Math.abs(r - c.circle.cy) < K_; )
    ...
    function G_(t) {
        ...
        if ((W_.insert(n, f), n || e)) {
            if (n === e)
                return (
                    B_(n), (e = H_(n.site)), W_.insert(f, e), (f.edge = e.edge = E_(n.site, f.site)), Y_(n), void Y_(e)
                );
            if (e) {
                B_(n), B_(e);
                var c = n.site,
    ...
    function eb(t, n) {
        ...
        for (J_ = [], Z_ = new Array(t.length), W_ = new M_(), Q_ = new M_(); ; )
            if (((i = U_), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
                (o[0] === e && o[1] === r) || (G_(o), (e = o[0]), (r = o[1])), (o = t.pop());
            else {
                if (!i) break;
                X_(i.arc);
            }
        if (
            ...
            !(function(t, n, e, r) {
                for (var i, o = J_.length; o--; )
                    (z_((i = J_[o]), t, n, e, r) &&
                        P_(i, t, n, e, r) &&
                        (Math.abs(i[0][0] - i[1][0]) > K_ || Math.abs(i[0][1] - i[1][1]) > K_)) ||
                        delete J_[o];
            })(a, u, f, c),
                (function(t, n, e, r) {
                    var i,
                        ...
                        for (
                            ...
                            (a = d),
                                ...
                                a &&
                                    ...
                                    ((f = a),
                                    (c = d),
                                    ((u = s)[0] - c[0]) * (f[1] - u[1]) - (u[0] - f[0]) * (c[1] - u[1]) < 0) &&
    ...
    (ub.prototype = ob.prototype),
        ...
        (t.thresholdFreedmanDiaconis = function(t, e, r) {
            return (
                (t = d.call(t, u).sort(n)),
                Math.ceil((r - e) / (2 * (A(t, 0.75) - A(t, 0.25)) * Math.pow(t.length, -1 / 3)))
            );
        }),
                ...
                for (c = -1; ++c < l; )
                    for (s = c - 1; ++s < l; ) {
                        var A = _[s * l + c],
                            T = _[c * l + s];
                        (A.value || T.value) &&
                            v.push(A.value < T.value ? { source: T, target: A } : { source: A, target: T });
                    }
                return r ? v.sort(r) : v;
            }
            return (
        ...
        (t.ribbon = function() {
            ...
            function a() {
                ...
                if (
                    ...
                    o.moveTo(d, p),
                    o.arc(0, 0, s, l, h),
                    (l === g && h === y) || (o.quadraticCurveTo(0, 0, v * Li(g), v * Di(g)), o.arc(0, 0, v, g, y)),
        ...
        (t.nest = function() {
            ...
            function o(e, i, a, u) {
                ...
                for (var f, c, s, l = -1, h = e.length, d = r[i++], p = Ki(), v = a(); ++l < h; )
        ...
        (t.contourDensity = function() {
            ...
            function l(r) {
                ...
                r.forEach(function(r, o, s) {
                    ...
                    yo({ width: f, height: c, data: i }, { width: f, height: c, data: l }, o >> a),
                    _o({ width: f, height: c, data: l }, { width: f, height: c, data: i }, o >> a),
                    yo({ width: f, height: c, data: i }, { width: f, height: c, data: l }, o >> a),
                    _o({ width: f, height: c, data: l }, { width: f, height: c, data: i }, o >> a),
                    yo({ width: f, height: c, data: i }, { width: f, height: c, data: l }, o >> a),
                    _o({ width: f, height: c, data: l }, { width: f, height: c, data: i }, o >> a);
            ...
            return (
                ...
                (l.thresholds = function(t) {
                    return arguments.length
                        ? ((s = 'function' == typeof t ? t : Array.isArray(t) ? co(uo.call(t)) : co(t)), l)
                        : s;
                }),
        ...
        (t.drag = function() {
            ...
            function m(n, e, r, i, o) {
                var a,
                    ...
                    v = s.copy();
                if (
                    Ct(new $t(d, 'beforestart', a, n, l, p[0], p[1], 0, 0, v), function() {
                        return (
                    ...
                    return function t(u) {
                        ...
                        Ct(new $t(d, u, a, n, s, p[0] + f, p[1] + h, p[0] - g[0], p[1] - g[1], v), v.apply, v, [
                            u,
                            i,
                            o,
                        ]);
            ...
            function o() {
                for (var t, o, u, f, c, s, l, h = n.length, d = 0; d < i; ++d)
                    for (o = ra(n, ua, fa).visitAfter(a), t = 0; t < h; ++t)
                        (u = n[t]), (s = e[u.index]), (l = s * s), (f = u.x + u.vx), (c = u.y + u.vy), o.visit(p);
            ...
            function l() {
                if (r) {
                    ...
                    for (u = 0, o = new Array(s); u < s; ++u)
                        (f = t[u]), (o[u] = i[f.source.index] / (i[f.source.index] + i[f.target.index]));
        ...
        (t.geoBounds = function(t) {
            ...
            if (((Ru = zu = -(Cu = Pu = 1 / 0)), (Ou = []), su(t, rf), (e = Ou.length))) {
                ...
                for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
                    (i = o[n]), (u = hf(r[1], i[0])) > a && ((a = u), (Cu = i[0]), (zu = r[1]));
            }
        ...
        (t.geoPath = function(t, n) {
            ...
            function o(t) {
                return (
                    t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), su(t, e(r))), r.result()
                );
            }
            return (
                (o.area = function(t) {
            ...
            return (
                (s.invert = function(t) {
                    ...
                    return (i >= 0.12 && i < 0.234 && r >= -0.425 && r < -0.214
                        ? u
                        : i >= 0.166 && i < 0.234 && r >= -0.214 && r < -0.115 ? f : a
                    ).invert(t);
                }),
                (s.stream = function(e) {
                    return t && n === e
                ...
                (s.scale = function(t) {
                    return arguments.length
                        ? (a.scale(t), u.scale(0.35 * t), f.scale(t), s.translate(a.translate()))
                        : a.scale();
                }),
                ...
                clipExtent: function(r) {
                    return arguments.length
                        ? ((d =
                              null == r
                                  ? ((h = t = n = e = null), mc)
                                  : Zf((h = +r[0][0]), (t = +r[0][1]), (n = +r[1][0]), (e = +r[1][1]))),
                          p())
                        : null == h ? null : [[h, t], [n, e]];
                },
                scale: function(t) {
        ...
        (t.stratify = function() {
            ...
            function e(e) {
                ...
                for (i = 0; i < s; ++i)
                    (r = e[i]),
                        (u = l[i] = new hl(r)),
                        null != (f = t(r, i, e)) && (f += '') && (h[(c = Ul + (u.id = f))] = c in h ? Ol : u);
                for (i = 0; i < s; ++i)
        ...
        (t.tree = function() {
            ...
            function o(n) {
                ...
                n.parent.A = (function(n, e, r) {
                    if (e) {
                        for (
                            var i, o = n, a = n, u = e, f = o.parent.children[0], c = o.m, s = a.m, l = u.m, h = f.m;
                            (u = Hl(u)), (o = Il(o)), u && o;
        ...
        (t.polygonContains = function(t, n) {
            for (
                var e, r, i = t.length, o = t[i - 1], a = n[0], u = n[1], f = o[0], c = o[1], s = !1, l = 0;
                l < i;
                ++l
            )
                (e = (o = t[l])[0]),
                    (r = o[1]) > u != c > u && a < (f - e) * (u - r) / (c - r) + e && (s = !s),
                    (f = e),
                    (c = r);
            return s;
        }),
        ...
        (t.interpolateRainbow = function(t) {
            ...
            return (Ag.h = 360 * t - 100), (Ag.s = 1.5 - 1.5 * n), (Ag.l = 0.8 - 0.9 * n), Ag + '';
        }),
                ...
                if ((u || (u = f = Gi()), h < l && ((c = h), (h = l), (l = c)), h > Fg))
                    if (v > jg - Fg)
                        u.moveTo(h * Ug(d), h * Yg(d)),
                            u.arc(0, 0, h, d, p, !g),
                            l > Fg && (u.moveTo(l * Ug(p), l * Yg(p)), u.arc(0, 0, l, p, d, g));
                    else {
                        var y,
                            _,
                            b = d,
                        ...
                        if (N > Fg) {
                            var C = Xg(N / l * Yg(T)),
                                P = Xg(N / h * Yg(T));
                            (M -= 2 * C) > Fg ? ((x += C *= g ? 1 : -1), (w -= C)) : ((M = 0), (x = w = (d + p) / 2)),
                                (A -= 2 * P) > Fg
                                    ? ((b += P *= g ? 1 : -1), (m -= P))
                                    : ((A = 0), (b = m = (d + p) / 2));
                        }
                            ...
                            if (v < Ig) {
                                var B =
                                    ...
                                    X =
                                        1 /
                                        Yg(
                                            ((s = (F * H + I * j) / (Bg(F * F + I * I) * Bg(H * H + j * j))) > 1
                                                ? 0
                                                : s < -1 ? Ig : Math.acos(s)) / 2,
                                        ),
                        ...
                        A > Fg
                            ? k > Fg
                              ? ((y = Qg(O, Y, z, R, h, k, g)),
                                ...
                                k < S
                                    ? u.arc(y.cx, y.cy, k, Dg(y.y01, y.x01), Dg(_.y01, _.x01), !g)
                                    : (u.arc(y.cx, y.cy, k, Dg(y.y01, y.x01), Dg(y.y11, y.x11), !g),
                                      u.arc(
                                          0,
                                          0,
                                          h,
                                      ...
                                      u.arc(_.cx, _.cy, k, Dg(_.y11, _.x11), Dg(_.y01, _.x01), !g)))
                            ...
                            l > Fg && M > Fg
                                ? E > Fg
                                  ? ((y = Qg(L, D, U, q, l, -E, g)),
                                    ...
                                    E < S
                                        ? u.arc(y.cx, y.cy, E, Dg(y.y01, y.x01), Dg(_.y01, _.x01), !g)
                                        : (u.arc(y.cx, y.cy, E, Dg(y.y01, y.x01), Dg(y.y11, y.x11), !g),
                                          u.arc(
                                              0,
                                              0,
                                              l,
                                          ...
                                          u.arc(_.cx, _.cy, E, Dg(_.y11, _.x11), Dg(_.y01, _.x01), !g)))
                                  : u.arc(0, 0, l, w, x, g)
                                : u.lineTo(L, D);
                    }
                else u.moveTo(0, 0);
        ...
        (t.pie = function() {
            ...
            function a(a) {
                ...
                for (
                    ...
                    (f = p[u]),
                        (s = g + ((l = v[f]) > 0 ? l * c : 0) + b),
                        (v[f] = { data: a[f], index: u, value: l, startAngle: g, endAngle: s, padAngle: _ });
                return v;
            }
            return (
                (a.value = function(n) {
        ...
        (t.symbol = function() {
            ...
            function r() {
                var r;
                if ((e || (e = r = Gi()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r))
        ...
        (t.stack = function() {
            ...
            return (
                ...
                (i.order = function(t) {
                    return arguments.length
                        ? ((n = null == t ? g_ : 'function' == typeof t ? t : Rg(dy.call(t))), i)
                        : n;
                }),
                (i.offset = function(t) {
        ...
        (t.active = function(t, n) {
            ...
            if (i)
                for (r in ((n = null == n ? null : n + ''), i))
                    if ((e = i[r]).state > gr && e.name === n) return new Pr([[t]], li, n, +r);
            return null;
        }),
        (t.interrupt = Nr),
        (t.voronoi = function() {
        ...
        (t.zoom = function() {
                        ...
                        i = Dt(t.event.view)
                            .on(
                                ...
                                function() {
                                    ...
                                    n.zoom(
                                        'mouse',
                                        o(b(n.that.__zoom, (n.mouse[0] = Ft(n.that)), n.mouse[1]), n.extent, c),
                                    );
                                },
                                !0,
                            )
            ...
            function S() {
                if (r.apply(this, arguments)) {
                    var e,
                        ...
                        c = f.length;
                    for (fb(), i = 0; i < c; ++i)
                        (a = [(a = It(this, f, (o = f[i]).identifier)), this.__zoom.invert(a), o.identifier]),
                            u.touch0 ? u.touch1 || (u.touch1 = a) : ((u.touch0 = a), (e = !0));
                    if (n && ((n = clearTimeout(n)), !u.touch1))
                        return u.end(), void ((a = Dt(this).on('dblclick.zoom')) && a.apply(this, arguments));
                    e &&
            ...
            return (
                ...
                (y.extent = function(t) {
                    return arguments.length
                        ? ((i = 'function' == typeof t ? t : rb([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])), y)
                        : i;
                }),
